...
const GallerySlider = () => {
  ...
  return (
    <div className="w-full bg-white dark:bg-black py-12 md:py-16">
      <div className="container mx-auto px-4">
        <h2 className="text-3xl md:text-4xl font-bold text-[#000051] dark:text-white text-center mb-8 md:mb-12">
