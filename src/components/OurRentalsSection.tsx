  ...
  return (
    <div className="w-full min-h-[700px] md:h-[700px] bg-white dark:bg-black md:bg-white flex flex-col items-center justify-center">
      ...
      <div className="w-full md:w-[2000px] h-[1000px] md:h-[450px] bg-[#000051] flex items-center justify-center p-4 md:p-0">
        <div className="w-[350px] md:w-[500px] h-[550px] bg-[#000051] dark:bg-[#000051] border-7 border-white shadow-[8px_9px_11px_3px_rgba(0,_0,_0,_0.1)] relative mb-[50px] rounded-lg top-[-150px] md:top-0" style={{ backgroundImage: "url('/pattern.svg')" }}>
          ...
          <div className="absolute bottom-[-520px] md:bottom-[-150px] left-1/2 -translate-x-1/2 md:hidden w-[90vw] max-w-[800px] h-[600px]">
            <Image 
              ...
              width={800}
              height={600}
              className="object-contain w-full h-full max-h-75"
